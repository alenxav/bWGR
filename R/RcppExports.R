...
MRR3 <- function(Y, X, maxit = 1000L, tol = 10e-9, cores = 2L, TH = FALSE, NLfactor = 0.0, HCS = FALSE, XFA2 = FALSE) {
    .Call('_bWGR_MRR3', PACKAGE = 'bWGR', Y, X, maxit, tol, cores, TH, NLfactor, HCS, XFA2)
}
