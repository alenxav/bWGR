...
// PEGSX
SEXP PEGSX(MatrixXf Y, MatrixXf X, List Z_list, int maxit, float logtol, int cores, bool verbose, float df0, bool NonNegativeCorr, bool InnerGS, bool NoInv, bool XFA, int NumXFA);
