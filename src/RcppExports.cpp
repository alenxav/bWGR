...
// EigenARC
Eigen::MatrixXd EigenARC(Eigen::MatrixXd X, bool centralizeZ, int cores);
RcppExport SEXP _bWGR_EigenARC(SEXP XSEXP, SEXP centralizeZSEXP, SEXP coresSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(EigenARC(X, centralizeZ, cores));
